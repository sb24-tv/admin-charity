...
import Logo from '../images/logo/charity24.png';
...
const Header = (props: {
  ...
  return (
    <>
    <header className="sticky top-0 z-50 flex w-full bg-white box-shadow-custom dark:bg-boxdark dark:drop-shadow-none">
